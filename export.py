...
def export_onnx(model, im, file, opset, dynamic, simplify, prefix=colorstr("ONNX:")):
    ...
    torch.onnx.export(
        ...
        verbose=False,
        opset_version=opset,
        # =True,  # WARNING: DNN inference with torch>=1.12 may require do_constant_folding=False
        do_constant_folding=False,      # TODO: Se ha cambiado este valor para hacer pruebas por defecto True
        input_names=["images"],
